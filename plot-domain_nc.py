...
fig1 = plt.figure(figsize=(14, 22), frameon=False, dpi=200)
...
plt.savefig('domain_center_panartcit.png', pad_inches=0.0, bbox_inches='tight', transparent=True)
